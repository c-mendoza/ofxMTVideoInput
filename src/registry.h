...
//              REGISTRY_CONCAT(arg1, arg2, arg3, arg4)));
	...
	public:
		...
		template<typename ... Args>
		 T* create(const std::string& class_name, Args&& ... pack)
		{
		 ...
		 bool registerClass(const std::string& class_name, const ctor_t& ctor)
		{
		 ...
		 bool isRegistered(const std::string& class_name)
		{
